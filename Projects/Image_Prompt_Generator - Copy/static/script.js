document.addEventListener("DOMContentLoaded", () => {
            ...
            try {
                const res = await fetch('/api/prompts/save/', {
                    ...
                    body: JSON.stringify({
                        ...
                        category: state.selectedSubPromptType,
                        sub_style: state.selectedSub,
    ...
    const init = async () => {
        ...
        // Subcategory Logic (Dynamic Labels & Icons)
        ...
        // Art Styles & Format Reordering
        const formatSection = document.getElementById('formatSection');
        const styleSection = document.getElementById('styleSection');
        
        if (isImage) {
            styleSection.classList.remove('hidden');
            // Reorder: Style before Format for Image Prompts
            formatSection.parentNode.insertBefore(styleSection, formatSection);
            ...
            // Reset order: Format back to bottom if needed (though style is hidden)
            styleSection.parentNode.appendChild(styleSection);
        }
    };
    ...
    elements.generateBtn.onclick = async () => {
        ...
        elements.output.value = "Processing quantum algorithms...";
        ...
        try {
            ...
            elements.generateBtn.innerText = "GENERATE PROMPT";
